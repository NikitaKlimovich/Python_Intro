...
from source_code.db_manager import DatabaseManager, SchemaManager, DataLoader, DataSelector
...
def init():
    ...
    return ArgParserManager(), db_manager, SchemaManager(db_manager), DataLoader(db_manager), DataSelector(db_manager), DataWriter(write_folder)   
...
Choose a query: 1, 2, 3 or 4 or print 0 to exit\n"""
    arg_parser_manager, db_manager, schema_manager, data_loader, data_selector, data_writer = init()
